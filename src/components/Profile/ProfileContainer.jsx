...
export default function ProfileContainer({ data }) {
    return (
        <section style={{
            width: '60%', display: 'flex', alignItems: 'flex-start', justifyContent: 'center', padding: '30px 20px', background: '#000', borderRadius: '10px'
        }}>
            <div style={{ width: '100%', display: 'flex', alignItems: 'flex-start', justifyContent: 'flex-start', flexDirection: 'column', rowGap: '10px', color: "#fff" }
                ...
                {data.map((e) => (
                    <div key={e.text} style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                        <span style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', columnGap: "10px", fontSize: '16px' }}>
                            <span style={{ color: "white", fontSize: '19px' }}>{e.icon}</span>
                            {e.text}
                        </span>
                        {e.status && <div>
                            {
